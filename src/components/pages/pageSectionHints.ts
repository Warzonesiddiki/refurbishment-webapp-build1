...
export const PAGE_SECTION_HINTS: Record<GuidedPageKey, SectionHelpHintData> = {
  ...
  wipJobs: {
    ...
    bullets: [
      ...
      "Use Replace + Harvest to send removed RAM/SSD to Harvest QA Bin or Scrap Bin with traceability.",
      "Pass the quality gate (diagnosis + approved labor + parts evidence) before marking a job complete.",
      "Resolve offline queue conflicts before replaying actions after reconnect.",
      "Export replay audit CSV at shift close for supervisor review.",
      "Use technician productivity by track to rebalance work allocation.",
      "Escalate repeated offline conflict exceptions before allowing more replays.",
      "Review track productivity trends weekly to rebalance technician allocation.",
    ],
    tone: "purple",
  },
  scanner: {
