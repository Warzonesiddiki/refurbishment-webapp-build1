...
export function SettingsPage() {
  ...
  const maxBackupFileSizeBytes = 5 * 1024 * 1024;
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      input.onchange = async () => {
                        ...
                        if (!file) return;
                        if (file.size > maxBackupFileSizeBytes) {
                          setRestoreMessage({ tone: "error", text: "Backup file is too large. Maximum allowed size is 5MB." });
                          return;
                        }
